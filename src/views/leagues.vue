            ...
            <div class="league-container">
                ...
                <div class="leagues">
                    <div class="league">
                        ...
                        <div class="boxes row">
                            <div v-for="i , index in 5" class="col-6 col-xl-3 col-lg-3 col-md-4 mb-3">
                                <RouterLink :to="{ name: 'clup', params: { id: index + 1 } }">
                                    <div class="box">
                                        <img src="../assets/images/leg1.png" />
                    ...
                    <div class="league">
                        ...
                        <div class="boxes row">
                            <div v-for="i , index in 11" class="col-6 col-xl-3 col-lg-3 col-md-4 mb-3">
                                <RouterLink :to="{ name: 'clup', params: { id: index + 1 } }">
                                    <div class="box">
                                        <img src="../assets/images/leg1.png" />
                                        <span> الدوري المصري </span>
                    ...
                    <div class="league">
                        ...
                        <div class="boxes row">
                            <div v-for="i , index in 16" class="col-6 col-xl-3 col-lg-3 col-md-4 mb-3">
                            <RouterLink :to="{ name: 'clup', params: { id: index + 1 } }">
                                <div class="box">
                                    <img src="../assets/images/leg1.png" />
                                    <span> الدوري المصري </span>
                    ...
                    <div class="league">
                        ...
                        <div class="boxes row">
                            <div v-for="i , index in 6" class="col-6 col-xl-3 col-lg-3 col-md-4 mb-3">
                              <RouterLink :to="{ name: 'clup', params: { id: index + 1 } }">
                                    <div class="box">
                                        <img src="../assets/images/leg1.png" />
                                        <span> الدوري المصري </span>
