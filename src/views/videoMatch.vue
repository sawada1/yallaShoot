            ...
            <div class="video-page">
                <div class="head-line new mb-4">
                    <div class="d-flex align-items-center">
                        <h4 class="d-none d-xl-block d-lg-block"> مالتيميديا</h4>
                        <h4> | ملخص المباريات </h4>
                        <span class="neww">
                            | تياجو ميسي يهدر ركلة جزاء بطريقة غريبة
                        </span>
                    </div>
                </div>

                <div class="main">
                    <h3> تياجو ميسي يهدر ركلة جزاء بطريقة غريبة </h3>
                    ...
                    <div class="related mt-5">
                       ...
                       <div class="row">
                        <div v-for="i in 4" class="col-12 col-lg-3 col-xl-3 col-md-6 mb-3">
